...
public class RubberDaoJDBC extends JdbcTemplate implements RubberDao {
    ...
    private static final String query = "select  DATE_FORMAT(date,'%Y-%m-%d') as date,price_LKR from upuldi_CSEDAILYDATA.RUBBER_AUCTION_PRICE where item = ? and price_LKR <> '0.00' order by date  desc";
