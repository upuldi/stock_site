...
public class ASPIDaoJDBC extends JdbcTemplate implements ASPIDao{
    ...
    private static final String query = "select  DATE_FORMAT(date,'%Y-%m-%d') as date ,open,high,low,close,vol from upuldi_CSEDAILYDATA.EOD_DATA where ticker =  'BFL.N0000'";
