...
public class EODForignHoldingDaoJDBC extends JdbcTemplate implements EODForignHoldingDao {
    ...
    private static final Logger log = Logger.getLogger(EODForignHoldingDaoJDBC.class);

    private static final String query = "select L.Company_name ,  L.FH - E.FH as Diff\n" +
