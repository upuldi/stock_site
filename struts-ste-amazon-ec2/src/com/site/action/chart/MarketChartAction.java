...
public class MarketChartAction extends ActionSupport {
    ...
    public String marketIndex() {
        ...
        doMarketIndexPageThings();
        return "index";
    }

    public String marketIndexASPI() {
        selectedLink = "index";
        doMarketIndexPageThings();
        return "index-aspi";
    }

    public String marketIndexMPI() {
        selectedLink = "index";
        doMarketIndexPageThings();
        return "index-mpi";
    }

    public String marketIndexSNP20() {
        selectedLink = "index";
        doMarketIndexPageThings();
        return "index-snp20";
    }

    public String marketIndexSectors() {
        selectedLink = "index";
        doMarketIndexPageThings();
        return "index-sectors";
    }

    private void doMarketIndexPageThings() {
