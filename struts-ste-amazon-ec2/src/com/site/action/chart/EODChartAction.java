 ...
 */
public class EODChartAction extends ActionSupport {

    private String stockCode;
    private String stockCodeOnly;
    ...
    public String submitData() {
        ...
        try {
            ...
            if (null != stockCode && null == stockCodeOnly) {
                showChart = true;
                stockCodeOnly = stockCode.substring(stockCode.indexOf("[")+1,stockCode.indexOf("]"));
            }

            EODData eodData = eodDataManager.getLatestEODDataForStock(stockCodeOnly);
            ...
            Ticker ticker = cseListedCompanyManager.getTickerBySymbol(stockCodeOnly);
            this.ticker = ticker;
