 ...
 */
public class EODChartSideBarAction extends ActionSupport {
    ...
    public String inputDataSimple() {
        init();
        showChart = false;
        stockCode = null;
        return "simple";
    }
    public String inputDataGray() {
        init();
        showChart = false;
        stockCode = null;
        return "gray";
    }
    public String inputDataCompact() {
        init();
        showChart = false;
        stockCode = null;
        return "compact";
    ...
    public String submitDataSimple() {
    ...
    public String submitDataCompact() {
