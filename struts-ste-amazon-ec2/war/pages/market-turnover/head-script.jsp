...
$(function () {
    ...
    /* ASPI*/
    $.getJSON('http://localhost:8080/struts-site/hcMarketDataServlet.hcMarketDataServlet?type=HC_TO&callback=?', function (data1) {

            // Create the chart
            window.chart1 = new Highcharts.StockChart({

                chart:{
                    renderTo:'containerTO', zoomType:'x'
                },
                ...
                title:{
                    text:'Market Turnover Movements'
                },
                subtitle:{
                    text:'CSE Market Turnover - CSEWatch'
                },
                rangeSelector:{
                    buttons:[
                        {
