...
<div class="box">
    ...
    <fieldset>
        ...
        <s:form action="submitDataIssuedQtyChart.action">
    ...
    <s:if test="showChart == true ">
        ...
        <fieldset>
            ...
            <legend>Change of Issued Quentity of <s:property value="stockCode"/></legend>
            <h1></h1>
